...
4. **National identifiers:** KMG-MID, GERK, and the UVHVVR FFS register (`SI:UVHVVR-FFS-REG`/REGSR) bind through the Slovenia pilot profile's governed identity/code-binding and reference-snapshot artifacts — profile law, never universal Core law. (Originally worded "FITO-INFO"; corrected per ERRATA E-002 — FITO-INFO is shut down.)
