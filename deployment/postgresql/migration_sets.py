...
TENANT_AUTHORITATIVE_MIGRATION_SET = AuthoritativeMigrationSet(
    ...
    migrations=(
        ...
        AuthoritativeMigration(
            version=4,
            filename="0004_temporal_governance_runtime_bundle_role.sql",
            source_sha256=(
        ...
        AuthoritativeMigration(
            version=6,
            filename="0006_tenant_current_context_selection_owner_admission.sql",
            source_sha256=(
        ...
        AuthoritativeMigration(
            version=7,
            filename="0007_tenant_write_lock_selection_owner_admission.sql",
            source_sha256=(
    ...
    digest="sha256:9d4f8716e4b547b449c7d312ab738ca04048fa4cc7a75d048cc77e1bb1e0e672",
)
...
SECURITY_AUDIT_AUTHORITATIVE_MIGRATION_SET = AuthoritativeMigrationSet(
    ...
    migrations=(
        ...
        AuthoritativeMigration(
            version=4,
            filename="0004_temporary_export_lifecycle.sql",
            source_sha256=(
    ...
    digest="sha256:ac9c85a5766a072fa516ee15d607511fc0b5cf2b0651eb3d9087a5c086eb5b2c",
)
