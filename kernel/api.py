"""Production composition and the isolated legacy HTTP surface."""
...
if TYPE_CHECKING:
    ...
    from .legacy_runtime import DevelopmentRuntime, TestRuntime
...
def create_test_app(
    ...
    *,
    ...
    """The sole dependency-injection surface for tests and development."""
    ...
    elif mode is RuntimeMode.DEVELOPMENT and oidc is None:
        runtime = build_development_runtime(store, deployment_image_digest)
    else:
        raise ValueError("injected runtime mode differs")
...
def _legacy_app(runtime: DevelopmentRuntime | TestRuntime) -> FastAPI:
    from .legacy_runtime import TestRuntime
