...
| `kernel/tests/test_m2_manifest.py` | Active SI pilot manifest behavior and non-overclaiming posture. | `KEEP_AS_ACTIVE_RUNTIME_SI_SUPPORT` after D5; future split belongs to D5d or later. | Multi-profile manifest implementation and harness design before any relocation or split. |
