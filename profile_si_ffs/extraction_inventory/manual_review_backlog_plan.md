...
| D4 validation policy metadata | `validator_policy_hook_design.md` | PR #37 (`5518f55cfb3145ae81ae36df7442c984bcd582d5`), PR #37 (`6390093c69875c556c5da546939e584854f7c190`), and PR #68 (`34413c68f5a13a55cf7ab72e8b6438101e10cf49`); `kernel/tests/test_m2_si_validation_policy.py`; profile module `profile_si_ffs.tests.m2_si_validation_policy_tests`. |
...
| D6 test harness | `test_harness_split_plan.md` | PR #38 (`b5f54c0e18fb8c5ac0d6ac8ad49f7aeed9f81dd4`), PR #63 (`63e6430bb00cdc29ded1de30ef8ca5ef168bd944`), PR #64 (`45b3a50ffb1254b4ed2e6748517f62008beb4124`), PR #75 (`3c98188a02df3ab0de458afd2c7039768cce7c55`), PR #77 (`a21fed807dfcab67ffc605bd7d8a2d2e431a1bd0`), and PR #83 (`f82820c0141c5dae8655f546d72acb8ee11e7c25`); `kernel/tests/test_profile_harness_bridge.py`; root bridge files in `kernel/tests/`. |
| D7 conformance lanes | `conformance_lane_split_plan.md` | PR #39 (`1cc0383d36349c3037f683a99cd3eb74ab43900e`), PR #62 (`01eee6bf5dbd4dcffcc5c96034b1fd0aa9ac9c63`), PR #62 (`9e3e5cc40e4cc84eac2549d9060f15e504eb6f65`), PR #70 (`556ce395ed88d8abe294fdd3e39d107f26ca4e8a`), PR #74 (`5759b463483eed8ee5618babeeb0a7a450e79ffc`), PR #82 (`5e8839414d91aec7c138717bce46e5a97eea4403`), PR #81 (`8ff6d53b158e5320146cc948720f0852d9e50b7f`), and PR #83 (`f82820c0141c5dae8655f546d72acb8ee11e7c25`); `conformance/CONFORMANCE.md`; `conformance/evidence/README.md`; `conformance/evidence/platform_mvp_results_*.json`. |
